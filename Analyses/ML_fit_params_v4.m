function ML_fit_params_v4(ii)

ML_fit_init_v4 % run initialization script - set all parameters there 
...
save(sprintf('%s/glm_examp_time_cell_%i_v_%i.mat', params.folder_mat,cell_no,params.plot_version));
